 ...
 */
class ReadProperty extends OperationBase {
    ...
    async submitTransaction() {
        const readPropertyArgs = this.simpleState.getReadPropertyArguments();
        await this.sutAdapter.sendRequests(this.createConnectorRequest('readProperty', readPropertyArgs));
    }
}
